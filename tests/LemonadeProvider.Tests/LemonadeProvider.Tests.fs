...
type Generative2 = LemonadeProvider.GenerativeProvider<2>
type Generative4 = LemonadeProvider.GenerativeProvider<4>
...
[<Test>]
let ``Simple op_Subtraction`` () =
    let obj = Generative4()
    Assert.AreEqual(obj.Meth(30), 10)